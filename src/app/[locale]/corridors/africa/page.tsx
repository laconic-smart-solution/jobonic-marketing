    ...
    <>
      ...
      <section className="py-16">
        <div className="container space-y-8">
          ...
          <a href={PLATFORM_URL} target="_blank" rel="noreferrer" className="inline-flex rounded-full bg-primary px-6 py-3 text-sm font-semibold text-white hover:bg-primary/90">Post an Africa Service Need</a>
        </div>
      </section>
    </>
  );
